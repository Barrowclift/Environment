# Strongly connected graph Preliminary Project Plan
...
Code can be displayed inline like `public class FooBar` or in nice, Monokai-styled code blocks as well:
...
Tables are nicely styled as well:
...
<table>
  ...
  <tr>
    <td>3</td><td>Johnny Appleseed</td><td>Priceless</td>
  </tr>
</table>
